...
## هدف پروژه
بازنویسی کامل نرم‌افزار حسابداری محک (`mahak.exe`) از Delphi به .NET 8 با معماری مدرن:
- UI: WPF + MVVM  
...
**این فایل را به عنوان `MIGRATION.md` در ریشه ریپازیتوری ذخیره کنید.**  
همه دیاگرام‌ها با لینک مستقیم Imgur کار می‌کنند و در گیت‌هاب به‌خوبی نمایش داده می‌شوند.

اگر خواستید نسخه PDF یا Word هم داشته باشید، بگید تا در یک دقیقه آماده کنم.
